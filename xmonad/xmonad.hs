...
-- TODO
-- 1. port alt+d displays script (or find rofi script that does the same)
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- Spawn pelican cams
  , ((modMask, xK_s),
     spawn "vlc https://cams.cdn-surfline.com/cdn-ec/ec-pelicanbeachpark/chunklist.m3u8")
